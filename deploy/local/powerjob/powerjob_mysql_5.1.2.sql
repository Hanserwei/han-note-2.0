-- PowerJob 5.1.2 schema for the local-only scheduler database.
-- Source: https://github.com/PowerJob/PowerJob/blob/v5.1.2/others/sql/schema/powerjob_mysql_5.1.2.sql
-- PowerJob is licensed under the Apache License 2.0.
